...
const PublicPortfolio: React.FC<PublicPortfolioProps> = ({ slug }) => {
  ...
  const loadPortfolio = async () => {
    ...
    // Enhanced portfolio data with custom branding and animations
...
I believe in creating solutions that not only solve problems but also drive meaningful business growth. My approach combines technical excellence with strategic thinking to deliver results that matter.`,
      ...
      portfolio_items: [
        {
          ...
          description: 'Modern online store with AI-powered recommendations and seamless payment integration',
        ...
        },
        {
          ...
          description: 'Comprehensive SaaS platform for business automation with intelligent workflows',
        ...
        },
        {
          ...
          description: 'Patient management and appointment scheduling platform with real-time analytics',
        ...
        },
        {
          ...
          tech: ['Next.js', 'Firebase', 'Google Maps API', 'Three.js'],
          link: 'https://example.com'
        },
        {
        ...
        },
        {
          ...
          description: 'AI-powered social media management tool with content generation',
      ...
      is_public: true,
      slug: 'ayyan',
      unique_id: 'portfolio-ayyan-2024',
      stats: {
      ...
      tools: [
        ...
        'MongoDB', 'Redis', 'GraphQL', 'Kubernetes', 'Jenkins', 'Git'
      ],
      testimonials: [
        {
          name: 'Sarah Johnson',
